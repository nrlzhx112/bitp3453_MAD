...
//SelfNote: @SuppressLint("Range") if you want to use cursor

public class StudentAttendance extends SQLiteOpenHelper {
    ...
    public StudentAttendance(@Nullable Context context) {
